...
The latest version of the library is 0.3.4, which is available for Scala and
...
If you're using sbt, add the following to your build:
    ...
    libraryDependencies ++= Seq(
      ...
      "eu.timepit" %% "refined-scalaz"     % "0.3.4",         // optional, JVM only
      "eu.timepit" %% "refined-scodec"     % "0.3.4",         // optional
      "eu.timepit" %% "refined-scalacheck" % "0.3.4" % "test" // optional
    )
...
[0.3.4.markdown](https://github.com/fthomas/refined/blob/master/notes/0.3.4.markdown).
