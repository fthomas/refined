...
trait RefType[F[_, _]] extends Serializable {
  ...
  /**
    ...
    * inferred from its argument.
    */
  def refineM[P]: RefineMPartiallyApplied[F, P] = new RefineMPartiallyApplied
  ...
  /**
    ...
    */
  def refineMF[T, P]: RefineMFullyApplied[F, T, P] = new RefineMFullyApplied
  ...
  def coflatMapRefine[T, P, U](tp: F[T, P])(f: F[T, P] => U)(
      implicit v: Validate[U, P]): Either[String, F[U, P]] = refine(f(tp))
}
...
object RefType {
  ...
  implicit val refinedRefType: RefType[Refined] = new RefType[Refined] {
    override def unsafeWrap[T, P](t: T): Refined[T, P] = Refined.unsafeApply(t)
  ...
  implicit val tagRefType: RefType[@@] = new RefType[@@] {
