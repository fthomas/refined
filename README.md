...
The latest version of the library is 0.7.0, which is available for Scala and
...
[0.7.0.markdown](https://github.com/fthomas/refined/blob/master/notes/0.7.0.markdown).
