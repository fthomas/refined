...
class BooleanValidateSpec extends Properties("BooleanValidate") {
  ...
  property("And.isValid") = secure {
    notValid[FF[And]](()) && notValid[FT[And]](()) && notValid[TF[And]](()) &&
    isValid[TT[And]](())
  }
  ...
  property("Xor.isValid") = secure {
    notValid[FF[Xor]](()) && isValid[FT[Xor]](()) && isValid[TF[Xor]](()) &&
    notValid[TT[Xor]](())
  }
  ...
  property("Nand.isValid") = secure {
    isValid[FF[Nand]](()) && isValid[FT[Nand]](()) && isValid[TF[Nand]](()) &&
    notValid[TT[Nand]](())
  }
  ...
  property("Nor.isValid") = secure {
    isValid[FF[Nor]](()) && notValid[FT[Nor]](()) && notValid[TF[Nor]](()) &&
    notValid[TT[Nor]](())
  }
  ...
  property("AllOf.showExpr") = secure {
    showExpr[AllOf[Greater[_0] :: Less[_10] :: HNil]](5) ?= "((5 > 0) && (5 < 10) && true)"
  }
  ...
  property("AnyOf.showExpr") = secure {
    showExpr[AnyOf[Digit :: LowerCase :: Whitespace :: HNil]]('c') ?= "(isDigit('c') || isLower('c') || isWhitespace('c') || false)"
  }
  ...
  property("OneOf.showExpr") = secure {
    showExpr[OneOf[Digit :: LowerCase :: UpperCase :: HNil]]('c') ?= "oneOf(isDigit('c'), isLower('c'), isUpper('c'), false)"
  }

  property("OneOf.contramap(identity).accumulateShow") = secure {
    val v = Validate[Char, OneOf[Digit :: LowerCase :: HNil]]
    v.contramap(identity[Char]).accumulateShowExpr('c') ?=
      v.accumulateShowExpr('c')
  }
}
