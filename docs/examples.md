...
<console>:22: error: invalid inference: eu.timepit.refined.numeric.Greater[shapeless.nat._5] ==> eu.timepit.refined.numeric.Greater[shapeless.nat._6]
...
<console>:38: error: Predicate isEmpty() did not fail.
              refineLit[NonEmpty]("")
                                 ^
...
<console>:39: error: Right predicate of (!(1.8 < 0) && !(1.8 > 1)) failed: Predicate (1.8 > 1) did not fail.
...
<console>:38: error: Predicate failed: "123.".matches("[0-9]+").
...
<console>:38: error: invalid inference: eu.timepit.refined.generic.Equal[Char('3')] ==> eu.timepit.refined.char.Letter
