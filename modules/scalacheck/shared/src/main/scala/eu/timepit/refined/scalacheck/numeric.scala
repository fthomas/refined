...
trait NumericInstances {
  ...
  implicit def numericMaxAndMinArbitrary[F[_, _], T: Choose, P](
      implicit rt: RefType[F],
      min: Min[F[T, P]],
      max: Max[F[T, P]]): Arbitrary[F[T, P]] =
    arbitraryRefType(Gen.choose(rt.unwrap(min.min), rt.unwrap(max.max)))

  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def lessArbitraryWit[F[_, _]: RefType, T: Numeric: Choose: Adjacent, N <: T](
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def lessArbitraryNat[F[_, _]: RefType, T: Choose: Adjacent, N <: Nat](
      implicit bounded: Bounded[T],
      nt: Numeric[T],
      tn: ToInt[N]
  ): Arbitrary[F[T, Less[N]]] =
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def lessEqualArbitraryWit[F[_, _]: RefType, T: Numeric: Choose, N <: T](
      implicit bounded: Bounded[T],
      wn: Witness.Aux[N]
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def lessEqualArbitraryNat[F[_, _]: RefType, T: Choose, N <: Nat](
      implicit bounded: Bounded[T],
      nt: Numeric[T],
      tn: ToInt[N]
  ): Arbitrary[F[T, LessEqual[N]]] =
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def greaterArbitraryWit[F[_, _]: RefType, T: Numeric: Choose: Adjacent, N <: T](
      implicit bounded: Bounded[T],
      wn: Witness.Aux[N]
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def greaterArbitraryNat[F[_, _]: RefType, T: Choose: Adjacent, N <: Nat](
      implicit bounded: Bounded[T],
      nt: Numeric[T],
      tn: ToInt[N]
  ): Arbitrary[F[T, Greater[N]]] =
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def greaterEqualArbitraryWit[F[_, _]: RefType, T: Numeric: Choose, N <: T](
      implicit bounded: Bounded[T],
      wn: Witness.Aux[N]
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def greaterEqualArbitraryNat[F[_, _]: RefType, T: Choose, N <: Nat](
      implicit bounded: Bounded[T],
      nt: Numeric[T],
      tn: ToInt[N]
  ): Arbitrary[F[T, GreaterEqual[N]]] =
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def intervalOpenArbitrary[F[_, _]: RefType, T: Numeric: Choose: Adjacent, L <: T, H <: T](
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def intervalOpenClosedArbitrary[F[_, _]: RefType, T: Numeric: Choose: Adjacent, L <: T, H <: T](
      implicit wl: Witness.Aux[L],
      wh: Witness.Aux[H]
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def intervalClosedOpenArbitrary[F[_, _]: RefType, T: Numeric: Choose: Adjacent, L <: T, H <: T](
      implicit wl: Witness.Aux[L],
      wh: Witness.Aux[H]
  ...
  @deprecated("Use numericMaxAndMinArbitrary instead", "0.8.6")
  def intervalClosedArbitrary[F[_, _]: RefType, T: Numeric: Choose, L <: T, H <: T](
      implicit wl: Witness.Aux[L],
      wh: Witness.Aux[H]
