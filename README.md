...
The latest version of the library is 0.6.2, which is available for Scala and
...
libraryDependencies ++= Seq(
  ...
  "eu.timepit" %% "refined-pureconfig" % "0.6.2"  // optional, JVM-only
  "eu.timepit" %% "refined-scalacheck" % "0.6.2", // optional
  "eu.timepit" %% "refined-scalaz"     % "0.6.2", // optional
  "eu.timepit" %% "refined-scodec"     % "0.6.2", // optional
)
```
...
[0.6.2.markdown](https://github.com/fthomas/refined/blob/master/notes/0.6.2.markdown).
