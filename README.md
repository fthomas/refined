...
[![Scaladoc](https://www.javadoc.io/badge/eu.timepit/refined_2.12.svg?color=blue&label=Scaladoc)](https://javadoc.io/doc/eu.timepit/refined_2.12/0.9.11)
...
Note that [`W`](https://static.javadoc.io/eu.timepit/refined_2.12/0.9.11/eu/timepit/refined/index.html#W:shapeless.Witness.type)
...
The latest version of the library is 0.9.11, which is available for Scala and
...
libraryDependencies ++= Seq(
  "eu.timepit" %% "refined"                 % "0.9.11",
  "eu.timepit" %% "refined-cats"            % "0.9.11", // optional
  "eu.timepit" %% "refined-eval"            % "0.9.11", // optional, JVM-only
  "eu.timepit" %% "refined-jsonpath"        % "0.9.11", // optional, JVM-only
  "eu.timepit" %% "refined-pureconfig"      % "0.9.11", // optional, JVM-only
  "eu.timepit" %% "refined-scalacheck"      % "0.9.11", // optional
  "eu.timepit" %% "refined-scalaz"          % "0.9.11", // optional
  "eu.timepit" %% "refined-scodec"          % "0.9.11", // optional
  "eu.timepit" %% "refined-scopt"           % "0.9.11", // optional
  "eu.timepit" %% "refined-shapeless"       % "0.9.11"  // optional
)
```
...
[0.9.11.markdown](https://github.com/fthomas/refined/blob/master/notes/0.9.11.markdown).
...
<https://static.javadoc.io/eu.timepit/refined_2.12/0.9.11/eu/timepit/refined/index.html>
