 ...
 *
 * scala> refineV[Greater[5]](BigInt(10))
 * res1: Either[String, BigInt Refined Greater[5]] = Right(10)
 *
 * scala> refineV[LessEqual[1.5]](1.4)
 * res2: Either[String, Double Refined LessEqual[1.5]] = Right(1.4)
 * }}}
 *
