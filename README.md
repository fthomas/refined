...
[![Scaladoc](https://www.javadoc.io/badge/eu.timepit/refined_2.12.svg?color=blue&label=Scaladoc)](https://javadoc.io/doc/eu.timepit/refined_2.12/0.9.23)
...
**Note** that [`W`](https://static.javadoc.io/eu.timepit/refined_2.12/0.9.23/eu/timepit/refined/index.html#W:shapeless.Witness.type)
...
The latest version of the library is 0.9.23, which is available for Scala and
...
libraryDependencies ++= Seq(
  ...
  "eu.timepit" %% "refined-cats"            % "0.9.23", // optional
  "eu.timepit" %% "refined-eval"            % "0.9.23", // optional, JVM-only
  "eu.timepit" %% "refined-jsonpath"        % "0.9.23", // optional, JVM-only
  "eu.timepit" %% "refined-pureconfig"      % "0.9.23", // optional, JVM-only
  "eu.timepit" %% "refined-scalacheck"      % "0.9.23", // optional
  "eu.timepit" %% "refined-scalaz"          % "0.9.23", // optional
  "eu.timepit" %% "refined-scodec"          % "0.9.23", // optional
  "eu.timepit" %% "refined-scopt"           % "0.9.23", // optional
  "eu.timepit" %% "refined-shapeless"       % "0.9.23"  // optional
)
```
...
Release notes for the latest version are [here](https://github.com/fthomas/refined/releases/tag/v0.9.23).
...
<https://static.javadoc.io/eu.timepit/refined_2.12/0.9.23/eu/timepit/refined/index.html>
