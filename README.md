...
The latest version of the library is 0.8.0, which is available for Scala and
...
[0.8.0.markdown](https://github.com/fthomas/refined/blob/master/notes/0.8.0.markdown).
